...
const company_stats = [
    ...
    { id: 3, value: "120K", text: "Employees work in all parts of the world" },
]
        ...
        <section>
            <div className="w-full relative h-[600px]">
                ...
                <div className="w-full h-full absolute top-0 left-0 rounded-3xl z-[99] bg-[rgba(0,0,0,.4)] flex items-center">
                    ...
                    <BannerHighlightCard
                        adding_style={'absolute top-20 right-40'}
                    />
                    ...
                    <div className="bg-white absolute bottom-0 right-0 flex gap-6 w-[600px] px-8 py-5 rounded-tl-3xl">
                        {
